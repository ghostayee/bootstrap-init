==> bootstrap
==> CSS/JS framework that helps you build responsive, mobile-first websites using ready made classes
 ==> setting up bootstrap
 =>CDN method
    => copy the css link and paste at the head section of the file in the link element on the href attribute
